...
function spotlight(config) {
  ...
  if (annotationText) {
    ...
    // TRUSTED INPUT ONLY: annotationText is always generated by the AI from PR diffs,
    // never from untrusted user input or external sources. No sanitization needed.
