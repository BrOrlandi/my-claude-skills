...
| 2 | rate-limit usage — 5-hour window, 7-day window, each with a pace arrow projecting whether you'll blow that limit at the current burn rate, and a dim `◍` region in the bar marking the time that passed without being spent (Pro/Max only) |
